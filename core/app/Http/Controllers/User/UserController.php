...
class UserController extends Controller
{
    ...
    public function buyPlan(Request $request)
    {
        ...
        try {
            ...
            // Record Total Profit in activity log
            $profitActivity = new \App\Models\ProfitActivityLog();
            $profitActivity->user_id = $user->id;
            $profitActivity->plan_id = $plan->id;
            $profitActivity->type = 'total_profit';
            $profitActivity->name = 'Total Profit';
    ...
    public function planProgress($planId)
    {
        ...
        if ($latestSubscription) {
            ...
            $profitActivities = \App\Models\ProfitActivityLog::where('user_id', $user->id)
