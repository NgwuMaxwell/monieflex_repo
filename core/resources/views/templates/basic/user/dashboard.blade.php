...
@endphp
    ...
    <div class="page">
        ...
        <div class="top-nav">
            ...
            <div class="news-block" style="margin-bottom: 25px;">
                <div class="right" style="width: 100%;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                        <div>
                            <p style="margin-bottom: 2px; font-size: 14px; color: #666;">Wallet Balance</p>
                            <h6 style="margin-bottom: 0; font-size: 18px; font-weight: 700; color: #151515;">
                                {{ $general->cur_text }} {{ number_format($user->balance, 2) }}
                            </h6>
                        </div>
                        <div style="text-align: right;">
                            <p style="margin-bottom: 2px; font-size: 14px; color: #666;">Task Earning</p>
                            <h6 style="margin-bottom: 0; font-size: 18px; font-weight: 700; color: #151515;">
                                {{ $general->cur_text }} {{ number_format($user->profit_wallet, 2) }}
                            </h6>
                        </div>
                    </div>
            ...
            <!-- Profit Wallet Section -->
            <div class="headings">
                <div class="title">Profit Wallet</div>
            </div>
                ...
                <div class="right" style="width: 100%;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                        <div>
                            ...
                            <h6 style="margin-bottom: 0; font-size: 18px; font-weight: 700; color: #151515;">
                                {{ $general->cur_text }} {{ number_format($user->referral_bonus, 2) }}
                            </h6>
                        </div>
                    </div>
                    <div style="text-align: center;">
