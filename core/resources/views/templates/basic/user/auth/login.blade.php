               ...
               <div class="form-group">
                    <div class="input-group">
                        ...
                        <div class="input-group-prepend">
                            <div class="input-group-text" style="width: fit-content;">Email</div>
                        </div>
                        
                        
                            <input type="text" name="username" value="{{ old('email') }}" class="form-control" placeholder="Email Id">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text"      style="width: fit-content;">Pass</div>
                        </div>
                ...
                <button class="btn btn-submit other mt-0" type="button" onclick="window.location.href='{{route ('user.register')}}'">Register</button>
