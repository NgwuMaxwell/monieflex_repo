...
<!-- Bootstrap -->
<link rel="stylesheet" href="{{ asset('assets/pub/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/pub/ajax/libs/font-awesome/6.0.0-beta2/css/all.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('assets/pub/ajax/libs/jquery/3.6.0.min.js') }}"></script>
    <script>
